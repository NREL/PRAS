...
function accumulator(sys::SystemModel{N}, ::SequentialMonteCarlo, ::Shortfall) where {N}
    ...
    return SMCShortfallAccumulator(
        periodsdropped_total,
        periodsdropped_region,
        periodsdropped_period,
        ...
        unservedload_region_currentsim,
    )
end
...
function finalize(
    ...
    ep_regionperiod_mean, ep_regionperiod_std = mean_std(acc.periodsdropped_regionperiod)
    ...
    ue_regionperiod_mean, ue_regionperiod_std = mean_std(acc.unservedload_regionperiod)
    ...
    return ShortfallResult{N, L, T, E}(
        ...
        ep_period_mean,
        ep_period_std,
        ep_regionperiod_mean,
        ep_regionperiod_std,
        p2e * ue_regionperiod_mean,
        p2e * ue_total_std,
        p2e * ue_region_std,
        p2e * ue_period_std,
        p2e * ue_regionperiod_std,
    )
end
