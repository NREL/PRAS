...
function merge!(x::SMCStorageEnergyAccumulator, y::SMCStorageEnergyAccumulator)
...
function accumulator(sys::SystemModel{N}, ::SequentialMonteCarlo, ::StorageEnergy) where {N}
    ...
    return SMCStorageEnergyAccumulator(energy_period, energy_storageperiod)
end
...
function merge!(x::SMCGenStorageEnergyAccumulator, y::SMCGenStorageEnergyAccumulator)
    foreach(merge!, x.energy_period, y.energy_period)
...
function accumulator(
    ...
    return SMCGenStorageEnergyAccumulator(energy_period, energy_genstorperiod)
end
...
function merge!(
    x::SMCStorageEnergySamplesAccumulator,
    y::SMCStorageEnergySamplesAccumulator,
)
    x.energy .+= y.energy
    return
end
