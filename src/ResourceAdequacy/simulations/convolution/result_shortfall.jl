...
function merge!(x::ConvolutionShortfallAccumulator, y::ConvolutionShortfallAccumulator)
    x.lolps .+= y.lolps
    x.euls .+= y.euls
    return
end
...
function record!(acc::ConvolutionShortfallAccumulator, t::Int, distr::CapacityDistribution)
