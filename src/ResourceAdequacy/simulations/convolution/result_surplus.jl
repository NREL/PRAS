...
function merge!(x::ConvolutionSurplusAccumulator, y::ConvolutionSurplusAccumulator)
    x.surplus .+= y.surplus
    return
end
...
function record!(acc::ConvolutionSurplusAccumulator, t::Int, distr::CapacityDistribution)
