struct SequentialSpatialResultAccumulator{N,L,T,P,E} <:
    ResultAccumulator{Spatial,Sequential}
...
function accumulator(
    ::Type{Sequential}, resultspec::Spatial, sys::SystemModel{N,L,T,P,E}
) where {N,L,T,P,E}
    ...
    return SequentialSpatialResultAccumulator{N,L,T,P,E}(
...
function update!(
    acc::SequentialSpatialResultAccumulator{N,L,T,P,E},
