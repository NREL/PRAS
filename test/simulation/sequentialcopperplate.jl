@testset "SequentialCopperplate" begin
    ...
    assess(SequentialCopperplate(100_000), Minimal(), singlenode_stor, seed)
    ...
    # Three-region system
    result_3 = assess(SequentialCopperplate(100_000), Minimal(),
                       threenode, seed)
    ...
    result_3 = assess(SequentialCopperplate(100_000), Temporal(),
                       threenode, seed)
    @test withinrange(LOLE(result_3), threenode_lole_copperplate, nstderr_tol)
    @test withinrange(EUE(result_3), threenode_eue_copperplate, nstderr_tol)
