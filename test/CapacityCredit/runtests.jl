@testset "CapacityCredit" begin
    ...
    emptystors = Storages{4, 1, Hour, MW, MWh}(
    ...
    sys_before = SystemModel(gens, emptystors, emptygenstors, timestamps, load)

    sys_after = SystemModel(gens_after, emptystors, emptygenstors, timestamps, load)
