...
singlenode_a = ResourceAdequacy.SystemDistribution{1,Hour,MW,MWh}(
    ["The Region"],
    [Generic([2.,3,4], [.3, .4, .3])],
    zeros(1, 10),
    Tuple{Int,Int}[],
...
singlenode_b = ResourceAdequacy.SystemDistribution{1,Hour,MW,MWh}(
...
threenode_a = ResourceAdequacy.SystemDistribution{1,Hour,MW,MWh}(
    ["A", "B", "C"],
    gen_dists, vg,
...
threenode_b = ResourceAdequacy.SystemDistribution{1,Hour,MW,MWh}(
...
threenode_multiperiod =
    ResourceAdequacy.SystemDistributionSet{1,Hour,4,Hour,MW,MWh}(
        collect(DateTime(2018,10,30,0):Dates.Hour(1):DateTime(2018,10,30,3)),
        ["Region A", "Region B", "Region C"], gen_dists,
        [.8 .7 .6 .7; .6 .4 .5 .7; .7 .8 .9 .8],
        line_labels, line_dists,
        [1.4 1.5 1.6 1.7; 1.5 1.6 1.7 1.6; 1.3 1.4 1.5 1.6]
)
