...
storages1 = hcat(ResourceAdequacy.StorageDeviceSpec(1., 4., 0.99, 0., 1.0))
storages2 = hcat(ResourceAdequacy.StorageDeviceSpec(1., 4., 0.99, 0.05, 0.5))
...
singlenode_stor = ResourceAdequacy.SystemModel{6,1,Hour,MW,MWh}(
    gens2, storages1, DateTime(2015,6,1,0):Hour(1):DateTime(2015,6,1,5),
    [1,1,1,2,2,2], ones(Int, 6), [7.,8,9,9,8,7], [28.,29,30,31,32,33])
